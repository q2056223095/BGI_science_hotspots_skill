...
> 华大教育中心科学热点转译技能包：把科学新闻转化为小红书科普文案、教育洞察、轮播图方案和可复用内容方法。

本仓库用于沉淀一套可持续复用的内容生产方法，帮助华大教育中心将科学热点转化为：
...
建议将以下两个新增文件也加入 `scripts/check_repo.py` 的必检项：
...
```text
Update README with anti-AI editing workflow
```
...
git add .
git commit -m "Update README with anti-AI workflow"
git push
```
